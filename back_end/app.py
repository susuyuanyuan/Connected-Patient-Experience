...
app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb+srv://admin:admin@cluster0.yg6ml.mongodb.net/portal?retryWrites=true&w=majority"
...
@app.route('/')
def base():
    return Response(response=json.dumps({"hello":"hi"}),
                    status=200,
